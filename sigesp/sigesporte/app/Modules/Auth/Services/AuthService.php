...
final class AuthService
{
    public function attempt(string $identifier, string $password, string $ip): bool
    {
        ...
        $q = Database::connection()->prepare('INSERT INTO tentativas_login (identificador_hash,ip,sucesso,motivo) VALUES (?,?,?,?)'); $q->execute([hash('sha256', strtolower(trim($identifier))), $ip, $valid ? 1 : 0, $valid ? null : 'credenciais_invalidas']);
