...
- Menus de ações de tabelas devem usar `table-action-dropdown` e o portal global em `assets/js/fluxempresa-app.js`; não prenda `.dropdown-menu` ao overflow da tabela nem resolva removendo `overflow-x` dos painéis.
