...
foreach (['fornecedores.php', 'contas-pagar.php', 'usuarios.php', 'relatorios.php', 'frente-caixa.php', 'caixa-vendas.php', 'caixa-movimentacoes.php', 'adm/index.php', 'adm/teste-conexao-so.php'] as $page) {
