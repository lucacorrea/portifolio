...
try {
    ...
    echo json_encode([
        'budget' => [
            ...
            'creator_name' => $budget->creatorName(),
            'creator_profile_name' => $budget->creatorProfileName(),
            'created_by_support' => $budget->createdBySupport(),
            'approver_name' => $budget->approverName(),
            'approver_profile_name' => $budget->approverProfileName(),
            'so_acquisition_number' => $budget->soAcquisitionNumber(),
            'so_delivery_code' => $budget->soDeliveryCode(),
            'so_acquisition_status' => $budget->soAcquisitionStatus(),
            'so_integration_status' => $budget->soIntegrationStatus(),
            'so_synchronized_at' => $budget->soSynchronizedAt(),
        ],
