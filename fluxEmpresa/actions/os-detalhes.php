...
try {
    ...
    if ($canViewValues) {
        $payload['order'] += ['services_subtotal' => $order->servicesSubtotal(), 'products_subtotal' => $order->productsSubtotal(), 'others_subtotal' => $order->othersSubtotal(), 'total' => $order->total()];
    }
