...
$linkBotaoAcao = 'index.php?area=recepcao&pagina=novoProtocolo';
?>
...
<head>
    ...
    <link rel="stylesheet" href="assets/css/recepcao/recepcao.css" />
</head>
<body>
    <div class="layout">
            ...
            <section class="main-grid">
                <article class="card panel">
                    <div class="panel-header">
                        ...
                        <a href="index.php?area=recepcao&pagina=protocolos" class="chip">Ver todos</a>
                    </div>
