...
/* ===== Carrega TODOS os beneficiários estaduais (paginação client-side) ===== */
try {
    $sql = "SELECT id, nome, cpf, beneficio_estadual_valor, numero, endereco, telefone, responsavel
          FROM solicitantes
          WHERE beneficio_estadual = 'Sim'
...
<head>
    <meta charset="utf-8">
    <title>Beneficiários – Estadual</title>
                    ...
                    <ul class="menu">
                        ...
                        <li class="sidebar-item has-sub active">
                            ...
                            <ul class="submenu active">
                                ...
                                <li class="submenu-item active"><a href="#">Estadual</a></li>
                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6">
                            <h3>Beneficiários – Estadual</h3>
                            <p class="text-subtitle text-muted">Lista de beneficiários de programas estaduais</p>
                        </div>
                        <div class="col-12 col-md-6">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Beneficiarios</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Estadual</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
