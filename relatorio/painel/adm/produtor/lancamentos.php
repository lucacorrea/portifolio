...
<head>
  ...
  <style>
    ...
    @media (max-width: 1200px){
      .line-grid{ grid-template-columns: 1fr 1fr .6fr .7fr .5fr 1fr auto; }
    }
                        ...
                        <div class="line-actions">
                          <div class="d-flex flex-column align-items-end" style="gap:8px;">
                            ...
                            <div class="d-flex" style="gap:8px;">
                              <button type="button" class="btn btn-light btn-xs js-foto"><i class="ti-camera"></i> Foto</button>
                              <button type="button" class="btn btn-light btn-xs js-remove" disabled><i class="ti-trash"></i></button>
                            </div>
                          </div>
