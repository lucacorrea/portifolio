        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                ...
                <footer class="footer">
                    ...
                    <div class="d-sm-flex justify-content-center justify-content-sm-between">
                        <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Desenvolvidor por <a href="https://www.themewagon.com/" target="_blank">Lucas Correa</a></span>
                    </div>
                </footer>
            </div>
        </div>
