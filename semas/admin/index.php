...
function admin_index_has_valid_session(): bool
{
    ...
    if ($role === 'admin') {
        return $autorizado === 'sim';
    }

    return in_array($role, ['prefeito', 'suporte', 'secretario'], true);
}

if (admin_index_has_valid_session()) {
                        ...
                        <div class="col-md-10">
                            <div class="card card-transparent shadow-none d-flex justify-content-center mb-0 auth-card">
                                <div class="card-body">
                                    ...
                                    <form action="./auth/processarLogin.php" method="POST" novalidate>
                                        <div class="row">
                                            <div class="col-lg-12">
