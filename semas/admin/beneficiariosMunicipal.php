            ...
            <div class="card-body">
              <div class="beneficiarios-card-head">
                ...
                <div class="dt-search-wrap">
                  <input type="text" id="qLive" class="dt-search-input"
                ...
                <table class="table beneficiarios-table align-middle w-100 text-nowrap mb-0" id="tbl">
                  ...
                  <tbody id="tbody">
                    <?php foreach ($rows as $r): ?>
                      ...
                      $valorSort = ($r['beneficio_municipal_valor'] === null || $r['beneficio_municipal_valor'] === '') ? '' : (string)(float)$r['beneficio_municipal_valor'];
                      ?>
                      <tr
                        data-id="<?= (int)$r['id'] ?>"
                        data-nome="<?= e($rowNome) ?>"
                        data-cpf="<?= e($cpfDigits) ?>"
                        data-valor="<?= e($valorSort) ?>"
                        data-telefone="<?= e($telDigits) ?>"
                        data-endereco="<?= e($rowEnd) ?>"
                        data-numero="<?= e($rowNum) ?>"
                        data-responsavel="<?= e($rowResp) ?>">
                        <td class="td-cpf nowrap"><?= e(formatCpf($r['cpf'])) ?></td>
                        <td class="td-nome"><?= e($r['nome']) ?></td>
                        <td class="td-valor"><?= e(moneyBR($r['beneficio_municipal_valor'])) ?></td>
                        <td class="td-numero"><?= e($r['numero']) ?></td>
                        <td class="td-endereco"><span class="cell-truncate" title="<?= e($r['endereco']) ?>"><?= e($r['endereco']) ?></span></td>
                        <td class="td-telefone nowrap"><?= e(formatPhone($r['telefone'])) ?></td>
                        <td class="td-responsavel"><span class="cell-truncate" title="<?= e($r['responsavel']) ?>"><?= e($r['responsavel']) ?></span></td>
