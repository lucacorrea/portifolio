...
/**
 * Se já estiver logado como admin, manda para o dashboard do admin.
 * Depois vamos trocar esse caminho para a rota central do sistema.
 */
if (!empty($_SESSION['auth']) && ($_SESSION['auth']['guard'] ?? '') === 'admin') {
...
<head>
    ...
    <meta name="description" content="Acesso administrativo da plataforma SaaS ContaFlow.">
                    ...
                    <div class="hero-list">
                        ...
                        <div class="hero-item">
                            ...
                            <div class="hero-item-text">
                                ...
                                <span>Controle vencimentos, pagamentos, atrasos e receita recorrente do SaaS.</span>
                            </div>
                        </div>
                        ...
                        <div class="hero-item">
                            ...
                            <div class="hero-item-text">
                                ...
                                <span>Centralize tickets e monitore a operação da plataforma com mais segurança.</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="login-side">
            <div class="login-card">
                <div class="login-header">
                    <h1>Entrar</h1>
                    <p>
                        Faça login para acessar o painel administrativo da plataforma.
                    </p>
                </div>
                ...
                <form action="/login.php" method="POST" autocomplete="off">
                    ...
                    <div class="form-row">
                        <label class="checkbox-wrap" for="lembrar">
                ...
                <div class="demo-box">
                    ...
                    <p>
                        Use o login super admin que estamos cadastrando no banco para entrar na plataforma.
                    </p>
                </div>
