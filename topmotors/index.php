                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="slider_text text-center">
                                <h3>Top Motors</h3>
                                <p>Encontre a moto ideal para você</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="slider_text text-center">
                                ...
                                <p>As melhores motos com preço justo</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                while ($r = $rooms->fetch_assoc()) { ?>
                    <div class="single_rooms">
                        <div class="room_thumb">
                            <img src="loja/uploads/<?= $r['imagem'] ?>" alt="" style="width:100%;height:260px;object-fit:cover;">
                            <div class="room_heading d-flex justify-content-between align-items-center">
                                <div class="room_heading_inner">
                                    <span>R$ <?= number_format($r['preco'], 2, ',', '.') ?></span>
                                    <h3><?= $r['nome'] ?></h3>
                                </div>
                                <a href="loja/visualizar.php?id=<?= $r['id'] ?>" class="line-button">ver moto</a>
                            </div>
                        </div>
                    </div>
                <?php } ?>
