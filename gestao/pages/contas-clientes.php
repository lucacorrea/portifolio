...
<style>
  .account-alert { margin-bottom: 14px; padding: 13px 15px; border-radius: 16px; border: 1px solid var(--line); font-size: 13px; font-weight: 850; }
  ...
  .account-alert .alert-actions { margin-top: 10px; display: flex; gap: 8px; flex-wrap: wrap; }
  .account-shell { display: grid; gap: 16px; }
  .account-filter-card, .account-card, .account-summary-card { background: #fff; border: 1px solid var(--line); border-radius: 22px; box-shadow: 0 10px 28px rgba(29,55,95,.06); }
  .account-filter-card { padding: 16px; }
  ...
  .account-status-pills a { white-space: nowrap; min-height: 38px; display: inline-flex; align-items: center; padding: 0 14px; color: var(--muted); background: #F7FAFE; border: 1px solid var(--line); border-radius: 999px; font-size: 12px; font-weight: 850; text-decoration: none; }
  ...
  .account-summary-card { padding: 15px; min-height: 88px; display: flex; flex-direction: column; justify-content: center; }
  .account-summary-card span { display: block; color: var(--muted); font-size: 11px; font-weight: 850; text-transform: uppercase; letter-spacing: .02em; }
  .account-summary-card strong { display: block; margin-top: 7px; color: var(--ink); font-size: 22px; line-height: 1; }
  .account-list { display: grid; gap: 14px; }
  .account-card { padding: 18px; }
  .account-card-header { display: flex; justify-content: space-between; gap: 14px; align-items: flex-start; }
  .account-card-meta { display: grid; gap: 5px; min-width: 0; }
  .account-card-meta h3 { margin: 0; color: var(--ink); font-size: 20px; line-height: 1.15; }
  .account-card-meta p { margin: 0; color: var(--muted); font-size: 13px; font-weight: 750; line-height: 1.45; }
  .account-card-meta .account-reference { color: var(--blue); font-weight: 850; }
  .account-values { display: grid; grid-template-columns: repeat(3, minmax(0,1fr)); gap: 10px; margin-top: 15px; }
  .account-values div { padding: 13px; border-radius: 16px; background: #F8FBFF; border: 1px solid var(--line); min-width: 0; }
  .account-values span { display: block; color: var(--muted); font-size: 10px; font-weight: 900; text-transform: uppercase; letter-spacing: .025em; }
  .account-values strong { display: block; margin-top: 5px; color: var(--ink); font-size: 16px; }
  .account-card-actions { display: flex; flex-wrap: wrap; gap: 10px; margin-top: 15px; }
  .account-card-actions .primary-btn, .account-card-actions .secondary-btn { min-height: 46px; flex: 1 1 170px; text-align: center; border: 0; cursor: pointer; text-decoration: none; }
  .account-card-actions .secondary-btn:disabled, .account-card-actions .primary-btn:disabled { opacity: .55; cursor: not-allowed; }
  .badge.muted { color: var(--muted); background: #F3F5F8; border-color: var(--line); }
  .account-empty { padding: 18px; color: var(--muted); font-weight: 800; text-align: center; }

  .account-modal[hidden] { display: none !important; }
  .account-modal { position: fixed; inset: 0; z-index: 9999; display: flex; align-items: center; justify-content: center; padding: 18px; }
  .account-modal-backdrop { position: absolute; inset: 0; background: rgba(15,23,42,.46); backdrop-filter: blur(2px); }
  .account-modal-dialog { position: relative; width: min(100%, 720px); background: #fff; border-radius: 26px; border: 1px solid var(--line); box-shadow: 0 24px 60px rgba(15,23,42,.22); overflow: hidden; z-index: 1; }
  .account-modal-dialog.small { width: min(100%, 560px); }
  .account-modal-header { display: flex; align-items: flex-start; justify-content: space-between; gap: 14px; padding: 19px 21px; border-bottom: 1px solid var(--line); }
  .account-modal-header h2 { margin: 4px 0 0; color: var(--ink); font-size: 24px; line-height: 1.1; }
  .account-modal-body { padding: 20px; display: grid; gap: 16px; }
  .modal-account-summary { display: grid; grid-template-columns: repeat(3, minmax(0,1fr)); gap: 10px; }
  .modal-account-summary div { padding: 14px; border: 1px solid var(--line); border-radius: 17px; background: #F8FBFF; min-width: 0; }
  .modal-account-summary span { display: block; color: var(--muted); font-size: 11px; font-weight: 850; text-transform: uppercase; letter-spacing: .03em; }
  .modal-account-summary strong { display: block; margin-top: 6px; font-size: 16px; color: var(--ink); overflow-wrap: anywhere; }
  .account-modal-grid { display: grid; grid-template-columns: repeat(2, minmax(0,1fr)); gap: 12px; }
  .account-modal-actions { display: flex; gap: 10px; justify-content: flex-end; flex-wrap: wrap; }
  .account-modal-actions .primary-btn, .account-modal-actions .secondary-btn { min-width: 160px; min-height: 46px; }
  .receipt-print-area { background: #fff; color: #111; border-radius: 16px; border: 1px dashed var(--line); padding: 18px; }
  .receipt-print-area h2 { margin: 0 0 8px; font-size: 19px; text-align: center; }
  .receipt-print-area p { margin: 5px 0; font-size: 12px; }
  .receipt-line { display: flex; justify-content: space-between; gap: 10px; border-top: 1px dashed #bbb; padding-top: 8px; margin-top: 8px; }
  ...
  @media (max-width: 760px) {
    .account-summary-grid, .account-values, .modal-account-summary, .account-modal-grid { grid-template-columns: 1fr; }
    .account-card-header { flex-direction: column; }
    .account-card-actions { flex-direction: column; }
    .account-modal { padding: 12px; align-items: flex-end; }
    .account-modal-dialog, .account-modal-dialog.small { width: 100%; border-radius: 24px 24px 0 0; max-height: 92vh; overflow-y: auto; }
    .account-modal-actions { flex-direction: column; }
    .account-modal-actions .primary-btn, .account-modal-actions .secondary-btn { width: 100%; min-width: 0; }
  }

  @media (max-width: 430px) {
    .account-filter-grid { grid-template-columns: 1fr; }
    .account-summary-card strong { font-size: 20px; }
...
<section class="content-pad account-shell">
  <?php if ($receipt): ?>
