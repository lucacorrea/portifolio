    ...
    <div class="card-body">
        ...
        <form action="" method="GET" class="filtros-grid">
            ...
            <div class="form-group filtros-acoes" style="margin-bottom: 0;">
                <a href="oficios_lista.php" class="btn btn-outline btn-limpar" style="width: 42px; padding: 0; display: flex; justify-content: center; align-items: center;" title="Limpar Filtros">
