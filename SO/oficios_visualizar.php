...
$anexos_orcamento = array_filter($anexos, function($a) { return $a['tipo'] === 'ORCAMENTO'; });
$anexos_oficio    = array_filter($anexos, function($a) { return $a['tipo'] === 'OFICIO'; });
        ...
        <div class="row" style="margin-bottom: 2.5rem;">
            <div class="col-md-4" style="margin-bottom: 1.5rem;">
                <div style="background: var(--bg-body); border: 1px solid var(--border-color); padding: 1.25rem; border-radius: 8px; height: 100%;">
                    <label style="font-size: 0.65rem; font-weight: 800; color: var(--text-muted); text-transform: uppercase; display: block; margin-bottom: 8px;"><i class="fas fa-building"></i> Secretaria Solicitante</label>
                    <div style="font-weight: 700; font-size: 1.125rem; color: var(--text-dark);"><?php echo $oficio['secretaria']; ?></div>
                    <div style="font-size: 0.875rem; color: var(--text-muted); margin-top: 8px;">Responsável: <strong><?php echo $oficio['sec_responsavel']; ?></strong></div>
                </div>
            </div>
            <div class="col-md-4" style="margin-bottom: 1.5rem;">
                <div style="background: var(--bg-body); border: 1px solid var(--border-color); padding: 1.25rem; border-radius: 8px; height: 100%;">
