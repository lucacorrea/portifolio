...
<!-- VIA SECRETARIA -->
<div class="card printable-page" id="via-secretaria">
    <div class="card-body">
        <div style="display: grid; grid-template-columns: 1fr auto 1fr; align-items: center; border-bottom: 2px solid #000; padding-bottom: 1.25rem; margin-bottom: 2rem; gap: 1rem;">
            <div>
                <h1 style="font-size: 1.25rem; font-weight: 800; margin: 0; color: #000; text-transform: uppercase;">PREFEITURA MUNICIPAL</h1>
            ...
            <div style="text-align: right;">
                <div style="font-weight: 800; color: #999; font-size: 0.65rem; text-transform: uppercase; margin-bottom: 6px; letter-spacing: 0.1em;">Cópia da Secretaria</div>
                <div style="border: 1.5px solid #000; padding: 0.4rem 1rem; display: inline-block; text-align: center;">
                    <div style="font-size: 0.6rem; font-weight: 800; color: #000; text-transform: uppercase;">Ofício Nº</div>
                    <div style="font-size: 1.25rem; font-weight: 900; color: #000; line-height: 1.1;"><?php echo str_replace('OF-', '', $oficio['numero']); ?></div>
                </div>
        ...
        <div style="background: #fcfdfe; border: 1px solid var(--border-color); padding: 1.25rem; border-radius: 8px; margin-bottom: 2.5rem;">
            <label style="font-size: 0.65rem; font-weight: 800; color: var(--text-muted); text-transform: uppercase; display: block; margin-bottom: 10px;">Unidade Solicitante</label>
            <div style="font-weight: 800; font-size: 1.25rem; color: var(--text-dark);"><?php echo $oficio['secretaria']; ?></div>
        </div>

        <h3 style="font-size: 0.75rem; font-weight: 800; color: var(--text-muted); text-transform: uppercase; border-bottom: 1px solid var(--border-color); padding-bottom: 5px; margin-bottom: 1rem;">Relação de itens solicitados</h3>
            ...
            <table class="table-vcenter" style="border: 1px solid var(--border-color);">
                ...
                <tbody>
                    ...
                    <tr>
                        <td style="color: var(--text-muted); font-size: 0.75rem;"><?php echo str_pad($idx + 1, 2, '0', STR_PAD_LEFT); ?></td>
                        <td style="font-weight: 700; color: var(--text-dark);"><?php echo $item['produto']; ?></td>
                        <td style="text-align: right; font-weight: 700; color: var(--text-dark);"><?php echo number_format($item['quantidade'], 2, ',', '.'); ?></td>
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 4rem; text-align: center; margin-top: auto;">
            <div>
                <div style="border-top: 1.5px solid var(--text-dark); padding-top: 1rem;">
                    <div style="font-weight: 800; color: var(--text-dark);"><?php echo $oficio['sec_responsavel']; ?></div>
                    <div style="font-size: 0.65rem; color: var(--text-muted); font-weight: 800; text-transform: uppercase;">Responsável pela Secretaria</div>
                </div>
            </div>
            <div>
                <div style="border-top: 1.5px solid var(--text-dark); padding-top: 1rem;">
                    <div style="font-weight: 800; color: var(--text-dark);">RECEBIDO EM: ____/____/____</div>
                    <div style="font-size: 0.65rem; color: var(--text-muted); font-weight: 800; text-transform: uppercase;">Protocolo Geral da Prefeitura</div>
                </div>
            </div>
        </div>
    </div>
