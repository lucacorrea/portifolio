        ...
        <div class="assinaturas-grid">
            <div class="assinatura-fornecedor-col">
                <div class="assinatura-linha assinatura-fornecedor-linha">
                    <?php if ($isSupport): ?>
                        <div class="support-signature-crop">
                            <img
...
<style>
    ...
    .rodape-documento{margin-top:1.8rem}.assinaturas-grid{display:grid;grid-template-columns:1fr 1fr;gap:3.5rem;text-align:center;margin-top:2.2rem}.assinatura-linha{position:relative;min-height:100px;padding:64px 8px 0;box-sizing:border-box}.assinatura-linha::before{content:"";position:absolute;left:4%;right:4%;top:60px;border-top:1.5px solid #000}.assinatura-titulo{font-weight:800;color:#000;font-size:.84rem;line-height:1.2;margin-top:8px}.assinatura-subtitulo{font-size:.63rem;color:#555;font-weight:700;text-transform:uppercase;margin-top:3px}
    .support-signature-crop{display:none;position:absolute;left:50%;top:0;transform:translateX(-50%);width:72%;height:58px;overflow:hidden;align-items:flex-start;justify-content:center;z-index:2}.printable-page.signature-enabled .support-signature-crop{display:flex}.support-signature-image{display:block;width:auto;max-width:100%;height:auto;max-height:72px;object-fit:contain;clip-path:inset(0 0 20% 0)}
    ...
    @media print{
        ...
        .rodape-documento{margin-top:10mm!important}.assinaturas-grid{display:grid!important;grid-template-columns:1fr 1fr!important;gap:18mm!important;text-align:center!important;margin-top:5mm!important;page-break-inside:avoid!important;break-inside:avoid!important}.assinatura-linha{position:relative!important;min-height:29mm!important;padding:18mm 2mm 0!important;box-sizing:border-box!important}.assinatura-linha::before{content:""!important;position:absolute!important;left:4%!important;right:4%!important;top:17mm!important;border-top:1px solid #000!important}.assinatura-titulo{font-size:9.3px!important;line-height:1.15!important;margin-top:1.5mm!important}.assinatura-subtitulo{font-size:7px!important;line-height:1.15!important;margin-top:.8mm!important}.support-signature-crop{position:absolute!important;left:50%!important;top:0!important;transform:translateX(-50%)!important;width:58mm!important;height:16.2mm!important;overflow:hidden!important;align-items:flex-start!important;justify-content:center!important;z-index:2!important}.printable-page.signature-enabled .support-signature-crop{display:flex!important}.support-signature-image{display:block!important;width:auto!important;max-width:58mm!important;height:auto!important;max-height:20mm!important;margin:0!important;object-fit:contain!important;clip-path:inset(0 0 22% 0)!important}
    }
</style>
