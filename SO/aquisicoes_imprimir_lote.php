                ...
                <?php else: ?>
                    ...
                    <?php foreach ($items as $item): ?>
                        ...
                        <tr>
                            ...
                            <td class="center"><?= money_br_lote($valorUnitario) ?></td>
                            <td class="center strong"><?= money_br_lote($valorItem) ?></td>
                        </tr>
                    <?php endforeach; ?>
...
<style>
    ...
    .ordem-header{display:grid;grid-template-columns:1fr auto 1fr;align-items:center;border-bottom:2px solid #000;padding-bottom:1.25rem;margin-bottom:2rem;gap:1rem}.ordem-logo{text-align:left}.ordem-logo img{max-height:80px;max-width:200px;object-fit:contain;width:100%}.ordem-center{text-align:center}.ordem-center h1{font-size:1.25rem;font-weight:800;margin:0;color:#000;text-transform:uppercase}.ordem-center h2{font-size:.8rem;font-weight:700;margin:2px 0 0;color:#333;text-transform:uppercase}.ordem-cnpj{font-size:.7rem;margin-top:4px;color:#666;font-weight:600}.ordem-right{text-align:right;justify-self:end;width:100%;padding-right:0;margin-right:-10px}.via-label{font-weight:800;color:#999;font-size:.65rem;text-transform:uppercase;margin-bottom:6px;letter-spacing:.1em}.ordem-right-box{border:1.5px solid #000;padding:.4rem 1rem;display:inline-block;text-align:center}.ordem-label{font-size:.6rem;font-weight:800;color:#000;text-transform:uppercase}.ordem-numero{font-size:1.25rem;font-weight:900;color:#000;line-height:1.1}.ordem-data{font-size:.7rem;color:#666;margin-top:8px;font-weight:600;text-transform:uppercase}
    .ordem-info-table,.ordem-items-table,.print-repeat-table{width:100%;border-collapse:collapse}.print-repeat-table>thead>tr>td,.print-repeat-table>tfoot>tr>td,.print-repeat-table>tbody>tr>td{padding:0;border:0}.ordem-info-wrap,.ordem-items-wrap{width:100%;overflow-x:auto;-webkit-overflow-scrolling:touch}.ordem-info-wrap{margin-bottom:1.35rem}.ordem-info-table{margin-bottom:0;font-size:.8125rem}.ordem-items-table{font-size:.8125rem;border:1px solid #000}.ordem-info-table td,.ordem-items-table th,.ordem-items-table td{border:1px solid #000;padding:6px 8px}.ordem-items-table thead tr,.ordem-total-row,.ordem-info-label{background:#f0f0f0}.ordem-info-label{font-weight:800;font-size:.7rem;text-transform:uppercase}.label-fornecedor{width:15%}.label-emissao{width:30%}.data-emissao{width:20%}.referencia{font-family:monospace;font-weight:900;letter-spacing:1px}.c-item{width:40px}.c-unid,.c-qtd{width:70px}.c-preco,.c-total{width:110px}.ordem-total-row td{border-bottom:1px solid #000!important}.total-label{font-size:.875rem;text-transform:uppercase}.total-value{font-size:.9375rem}.ordem-section-title{font-size:.75rem;font-weight:800;color:#333;text-transform:uppercase;margin:1.85rem 0 .5rem}
    .rodape-documento{margin-top:1.25rem}.assinaturas-grid{display:grid;grid-template-columns:1fr 1fr;gap:3rem;text-align:center;margin-top:1.5rem}.assinatura-linha{border-top:1.5px solid #000;padding-top:.75rem;position:relative}.assinatura-titulo{font-weight:800;color:#000;font-size:.875rem}.assinatura-subtitulo{font-size:.65rem;color:#555;font-weight:700;text-transform:uppercase;margin-top:3px}.support-signature-image{display:none;width:min(100%,260px);height:auto;margin:-70px auto 4px;object-fit:contain}.printable-page.signature-enabled .support-signature-image{display:block}.printable-page.signature-enabled .assinatura-fornecedor-linha{border-top-color:transparent}

    @media(max-width:768px){.print-topbar{flex-direction:column;align-items:stretch}.print-topbar .btn,.print-options .btn,.print-options .form-group,.support-signature-panel,.support-signature-panel .form-group{width:100%;justify-content:center;text-align:center}.print-options{width:100%}.printable-page .card-body{padding:1rem}.ordem-header{grid-template-columns:1fr;text-align:center}.ordem-right,.ordem-logo{justify-self:center;text-align:center;margin-right:0}.assinaturas-grid{grid-template-columns:1fr;gap:2rem}.ordem-info-table,.ordem-items-table{min-width:760px}.signature-page-control{position:static;margin:10px}}

    @media print{
        @page{size:A4 portrait;margin:6mm 6mm 7mm 6mm}html,body{background:#fff!important;margin:0!important;padding:0!important;width:100%}body *{visibility:hidden}.printable-page,.printable-page *{visibility:visible}.no-print,header,footer,.navbar,.page-header,.signature-page-control{display:none!important}.page-body,.container-xl,.print-doc{width:100%!important;max-width:100%!important;margin:0!important;padding:0!important}.printable-page{display:block!important;width:100%!important;max-width:100%!important;margin:0 0 4mm!important;padding:0!important;box-shadow:none!important;background:#fff!important;page-break-after:always;break-after:page;border-radius:0!important;overflow:visible!important}.print-doc .printable-page:last-child{page-break-after:auto;break-after:auto}.printable-page .card-body{padding:4mm 5mm!important}.ordem-header{gap:8px!important;margin-bottom:10px!important;padding-bottom:8px!important;grid-template-columns:1fr auto 1fr!important}.ordem-logo{margin-left:-70px!important}.ordem-logo img{max-height:70px!important;max-width:180px!important}.ordem-right{text-align:right!important;justify-self:end!important;width:100%!important;margin-right:-14px!important;padding-right:0!important}.ordem-info-wrap,.ordem-items-wrap{overflow:visible!important}.ordem-info-wrap{margin-bottom:10px!important}.ordem-info-table,.ordem-items-table,.print-repeat-table{width:100%!important;min-width:0!important;font-size:10px!important}.print-repeat-table>thead{display:table-header-group!important}.print-repeat-table>tbody{display:table-row-group!important}.print-repeat-table>tfoot{display:table-footer-group!important}.ordem-items-table{border:1px solid #000!important}.ordem-items-table thead{display:table-header-group!important}.ordem-info-table td,.ordem-items-table th,.ordem-items-table td{padding:4px 6px!important;border:1px solid #000!important}.ordem-section-title{margin:12px 0 4px!important;font-size:10px!important}.ordem-total-row,.ordem-total-row td,.rodape-documento{page-break-inside:avoid!important;break-inside:avoid!important}.rodape-documento{margin-top:8px!important}.assinaturas-grid{display:grid!important;grid-template-columns:1fr 1fr!important;gap:2rem!important;text-align:center!important;margin-top:24mm!important;page-break-inside:avoid!important;break-inside:avoid!important}.printable-page.signature-enabled .assinaturas-grid{margin-top:10mm!important}.assinatura-linha{border-top:1.5px solid #000!important;padding-top:6px!important}.printable-page.signature-enabled .assinatura-fornecedor-linha{border-top-color:transparent!important}.support-signature-image{width:72mm!important;max-height:25mm!important;margin:-4mm auto 1mm!important;object-fit:contain!important}}
</style>
