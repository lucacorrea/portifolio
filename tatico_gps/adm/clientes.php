        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item">
                        <a href="cobrancas.html" class="menu-link">
                    ...
                    <li class="menu-item">
                        <a href="pagamentos.html" class="menu-link">
                    ...
                    <li class="menu-item">
                        <a href="mensagens.html" class="menu-link">
                            ...
                            <div class="col-12">
                                <div class="card page-banner">
                                    <div class="card-body">
                                        ...
                                        <p>
                                            Gerencie a base de clientes do Tático GPS com uma lista mais limpa e
                                            formulário em modal.
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-3 col-md-6 mb-4">
                                <div class="card info-card h-100">
                                    <div class="card-body">
                                        ...
                                        <div class="info-value">248</div>
                                        <div class="info-meta text-primary">
                                            <i class="bx bx-group"></i> base cadastrada
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-3 col-md-6 mb-4">
                                <div class="card info-card h-100">
                                    <div class="card-body">
                                        ...
                                        <div class="info-value">211</div>
                                        <div class="info-meta text-success">
                                            <i class="bx bx-check-circle"></i> contratos ativos
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-3 col-md-6 mb-4">
                                <div class="card info-card h-100">
                                    <div class="card-body">
                                        ...
                                        <div class="info-meta text-danger">
                                            <i class="bx bx-error-circle"></i> requer cobrança
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-3 col-md-6 mb-4">
                                <div class="card info-card h-100">
                                    <div class="card-body">
                                        ...
                                        <div class="info-value">392</div>
                                        <div class="info-meta text-warning">
                                            <i class="bx bx-car"></i> total da carteira
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <div class="table-tools">
                                            <div class="left-tools">
                                                ...
                                                <span class="badge bg-label-primary">Dados fictícios</span>
                                            </div>
                                    ...
                                    <div class="card-body">
                                            ...
                                            <table class="table table-hover align-middle">
                                                ...
                                                <tbody class="table-border-bottom-0">
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex flex-column">
                                                                <span class="fw-semibold">João da Silva</span>
                                                                <small class="text-muted">CPF: 123.456.789-00</small>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="d-flex flex-column">
                                                                <span>(68) 99999-1111</span>
                                                                <small class="text-muted">joao@email.com</small>
                                                            </div>
                                                        </td>
                                                        <td>R$ 89,90</td>
                                                        <td>10</td>
                                                        <td><span class="vehicle-badge">1 Carro</span></td>
                                                        <td><small class="text-muted">CPF</small></td>
                                                        <td><span
                                                                class="badge bg-label-success badge-status">Ativo</span>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex flex-column">
                                                                <span class="fw-semibold">Maria Oliveira</span>
                                                                <small class="text-muted">CPF: 987.654.321-00</small>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="d-flex flex-column">
                                                                <span>(68) 99999-2222</span>
                                                                <small class="text-muted">maria@email.com</small>
                                                            </div>
                                                        </td>
                                                        <td>R$ 119,90</td>
                                                        <td>15</td>
                                                        <td><span class="vehicle-badge">2 Veículos</span></td>
                                                        <td><small class="text-muted">Telefone</small></td>
                                                        <td><span
                                                                class="badge bg-label-warning badge-status">Pendente</span>
                                                        </td>
                                                        <td class="text-center">
                                                            <div class="dropdown">
                                                                <button type="button"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex flex-column">
                                                                <span class="fw-semibold">Carlos Mendes</span>
                                                                <small class="text-muted">CPF: 741.852.963-00</small>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="d-flex flex-column">
                                                                <span>(68) 99999-3333</span>
                                                                <small class="text-muted">carlos@email.com</small>
                                                            </div>
                                                        </td>
                                                        <td>R$ 149,90</td>
                                                        <td>20</td>
                                                        <td><span class="vehicle-badge">1 Moto</span></td>
                                                        <td><small class="text-muted">E-mail</small></td>
                                                        <td><span
                                                                class="badge bg-label-danger badge-status">Bloqueado</span>
                                                        </td>
                                                        <td class="text-center">
                                                            <div class="dropdown">
                                                                <button type="button"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex flex-column">
                                                                <span class="fw-semibold">Ana Souza</span>
                                                                <small class="text-muted">CPF: 369.258.147-00</small>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="d-flex flex-column">
                                                                <span>(68) 99999-4444</span>
                                                                <small class="text-muted">ana@email.com</small>
                                                            </div>
                                                        </td>
                                                        <td>R$ 99,90</td>
                                                        <td>05</td>
                                                        <td><span class="vehicle-badge">1 Caminhonete</span></td>
                                                        <td><small class="text-muted">Chave aleatória</small></td>
                                                        <td><span
                                                                class="badge bg-label-success badge-status">Ativo</span>
                                                        </td>
                                                        <td class="text-center">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex flex-column">
                                                                <span class="fw-semibold">Ricardo Lima</span>
                                                                <small class="text-muted">CPF: 555.444.333-22</small>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="d-flex flex-column">
                                                                <span>(68) 99999-5555</span>
                                                                <small class="text-muted">ricardo@email.com</small>
                                                            </div>
                                                        </td>
                                                        <td>R$ 129,90</td>
                                                        <td>25</td>
                                                        <td><span class="vehicle-badge">3 Veículos</span></td>
                                                        <td><small class="text-muted">Telefone</small></td>
                                                        <td><span
                                                                class="badge bg-label-secondary badge-status">Inativo</span>
                                                        </td>
                                                        <td class="text-center">
                                                            <div class="dropdown">
                                                                <button type="button"
                                        ...
                                        <div
                                            ...
                                            <small class="mini-note">Mostrando 5 clientes fictícios para estrutura
                                                inicial da página.</small>
                    ...
                    <form>
                        ...
                        <div class="row g-3">
                            <div class="col-md-12">
                                ...
                                <input type="text" id="nome" class="form-control" placeholder="Ex.: João da Silva" />
                            </div>
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                ...
                                <input type="text" id="mensalidade" class="form-control" placeholder="R$ 89,90" />
                            </div>

                            <div class="col-md-4">
                                <label class="form-label" for="vencimento">Dia do vencimento</label>
                                <select id="vencimento" class="form-select">
                            ...
                            <div class="col-md-4">
                                ...
                                <select id="pix" class="form-select">
                                    <option selected>Selecione</option>
                                    <option>CPF</option>
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                ...
                                <input type="number" id="qtdVeiculos" class="form-control" placeholder="1" />
                            </div>

                            <div class="col-md-4">
                                <label class="form-label" for="tipoVeiculo">Tipo de veículo</label>
                                <select id="tipoVeiculo" class="form-select">
                                    <option selected>Selecione</option>
                                    <option>Moto</option>
                                    <option>Carro</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <select id="mensagemAuto" class="form-select">
                                    <option selected>Ativada</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" id="whatsContato" class="form-control"
                                    placeholder="(00) 00000-0000" />
                            </div>

                            <div class="col-12">
                                <label class="form-label" for="obs">Observações</label>
                                <textarea id="obs" class="form-control" rows="4"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <ul class="help-list">
                        ...
                        <li>
                            <span>Cadastro separado</span>
                            <span class="badge bg-label-primary">Melhor fluxo</span>
                        </li>
                        <li>
                            <span>Mensalidade</span>
                            <span class="badge bg-label-success">Incluída</span>
                        </li>
                        <li>
                            <span>Veículos</span>
                            <span class="badge bg-label-info">Incluído</span>
                        </li>
                        <li>
                            <span>PIX</span>
                            <span class="badge bg-label-warning">Incluído</span>
                        </li>
                        <li>
                            <span>Status</span>
                            <span class="badge bg-label-success">Incluído</span>
                        </li>
                    </ul>
