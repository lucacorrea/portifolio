<?php
// instalar_gerador.php - Página dedicada para instalação do App de Gerador de Códigos
?>
<!DOCTYPE html>
<html lang="pt-BR">
<head>
    ...
    <title>Instalar Gerador de Códigos - ERP Elétrica</title>
    
    <!-- PWA Support -->
    <link rel="manifest" href="manifest_gerar.json?v=3">
    ...
    <style>
        ...
        .btn-install {
            ...
            justify-content: center;
            gap: 12px;
            box-shadow: 0 10px 25px rgba(43, 76, 125, 0.4);
            transition: all 0.3s ease;
            text-transform: uppercase;
        }
        .btn-install:hover {
            transform: translateY(-3px);
            box-shadow: 0 15px 30px rgba(43, 76, 125, 0.5);
        }
        .btn-install:active {
...
<body>
    <div class="container">
        ...
        <h1>App Gerador</h1>
        <p>Gere códigos de autorização instantaneamente pela sua tela inicial.</p>
        
        <button id="btnInstall" class="btn-install">
            <i class="fas fa-shield-alt"></i> INSTALAR GERADOR
        </button>
        ...
        <div style="margin-top: 25px;">
            <a href="gerar_codigo.php" style="color: #fff; opacity: 0.6; text-decoration: none; font-size: 0.85rem;">
