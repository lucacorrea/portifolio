...
<aside class="sidebar" id="sidebar">
    <div class="sidebar-header d-flex align-items-center justify-content-center p-3">
        <img src="logo_sistema_erp_eletrica.png?v=1" alt="Centro do Eletricista" style="max-width: 90%; height: auto; max-height: 55px; filter: drop-shadow(0 0 5px rgba(255,193,7,0.2));">
    </div>
