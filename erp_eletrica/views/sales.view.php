        ...
        <div class="row g-4 mb-4">
            ...
            <div class="col-md-6">
                <div class="card border-0 shadow-sm h-100 text-center d-flex flex-column align-items-center justify-content-center p-3">
                    <div id="productPreviewImg" class="bg-light rounded mb-2 d-flex align-items-center justify-content-center border product-zoom-container" style="width: 100%; height: auto; min-height: 250px; max-height: 400px; aspect-ratio: 1/1; overflow: hidden;">
