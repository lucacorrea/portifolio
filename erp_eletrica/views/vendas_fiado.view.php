    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white border-0 shadow-sm">
                <h5 class="modal-title fw-bold text-white" style="color: #ffffff !important;"><i class="fas fa-hand-holding-dollar me-2 text-white" style="color: #ffffff !important;"></i>Receber Pagamento (AVS)</h5>
