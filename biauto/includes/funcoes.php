...
function modulo_pagina(string $pagina): string
{
    $mapa = [
        ...
        'cliente_form.php' => 'clientes',
        'veiculos.php' => 'veiculos',
        'veiculo_form.php' => 'veiculos',
        'mecanicos.php' => 'mecanicos',
        'mecanico_form.php' => 'mecanicos',
        'servicos.php' => 'servicos',
        'servico_form.php' => 'servicos',
        'pecas.php' => 'pecas',
        'peca_form.php' => 'pecas',
        'fornecedores.php' => 'pecas',
        'fornecedor_form.php' => 'pecas',
        'estoque_historico.php' => 'pecas',
        'relatorios.php' => 'relatorios',
        'configuracoes.php' => 'configuracoes',
        'auditoria.php' => 'configuracoes',
        'cadastro.php' => 'usuarios',
        'usuarios.php' => 'usuarios',
        'usuario_form.php' => 'usuarios',
        'busca.php' => 'busca',
        'logout.php' => 'logout',
        'login.php' => 'login',
    ];
