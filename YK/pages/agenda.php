...
<?php function agenda_return_fields(string $view, DateTimeImmutable $periodStart): void { echo '<input type="hidden" name="return_view" value="' . h($view) . '"><input type="hidden" name="return_date" value="' . h($periodStart->format('Y-m-d')) . '">'; } ?>
