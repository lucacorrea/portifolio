                        ...
                        <section class="mobile-records" aria-label="Famílias beneficiárias em cartões">
                            <?php foreach ($items as $row): ?>
                                ...
                                <article class="mobile-record-card">
                                    ...
                                    <div class="mobile-record-actions"><button class="btn btn-primary flex-grow-1" type="button"<?= $canDeliver ? ' data-open-delivery data-registration-id="' . e($row['inscricao_id']) . '" data-registration-name="' . e($row['responsavel_nome']) . '" data-family-code="' . e($row['familia_codigo']) . '"' : ' disabled title="Sem permissão"' ?>><i class="bi bi-basket2"></i>Registrar entrega</button><button class="btn btn-light btn-icon" type="button"<?= $canEdit ? ' data-open-edit data-registration-id="' . e($row['inscricao_id']) . '"' : ' disabled title="Sem permissão"' ?>><i class="bi bi-pencil"></i></button></div>
                                </article>
                            <?php endforeach; ?>
                        </section>
                    </div>
