...
<head>
    ...
    <meta name="description" content="Centro de Referência de Assistência Social — Território Sul">
    <title>SIGAS Coari — CRAS 2</title>
        ...
        <div class="app-main">
            ...
            <main class="app-content">
                ...
                <section class="dashboard-grid" aria-label="Indicadores da unidade">
                        ...
                        <strong class="stat-value">1.664</strong>
                    ...
                    <article class="stat-card col-span-3">
                        ...
                        <strong class="stat-value">61</strong>
                    ...
                    <article class="stat-card col-span-3">
                        ...
                        <strong class="stat-value">9</strong>
                    ...
                    <article class="content-card col-span-8"><div class="card-heading"><div><div class="card-kicker">Produção da unidade</div><h2>Atendimentos por semana</h2><p>Histórico das últimas oito semanas.</p></div><span class="status-badge status-success"><i class="bi bi-arrow-repeat"></i>Atualizado hoje</span></div><div class="chart-wrap"><canvas id="cras2Production" data-chart="bar" data-chart-labels='["S1", "S2", "S3", "S4", "S5", "S6", "S7", "S8"]' data-chart-values='[246, 271, 254, 289, 278, 304, 296, 318]' data-chart-label="Atendimentos" aria-label="Atendimentos"></canvas></div></article>
                    <article class="content-card col-span-4"><div class="card-heading"><div><div class="card-kicker">Unidade</div><h2>Informações operacionais</h2></div></div><div class="reference-card"><span>Território de abrangência</span><strong>Centro, Itamarati, Duque de Caxias e comunidades próximas</strong></div><div class="reference-card"><span>Coordenação</span><strong>Roberto Almeida</strong></div><div class="reference-card"><span>Horário</span><strong>Segunda a sexta, 08h às 17h</strong></div><div class="reference-card"><span>Contato institucional</span><strong>(97) 3561-0000 · unidade@sigas.coari.am.gov.br</strong></div></article>
