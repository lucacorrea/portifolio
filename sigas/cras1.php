...
<head>
    ...
    <meta name="description" content="Centro de Referência de Assistência Social — Território Norte">
    <title>SIGAS Coari — CRAS 1</title>
...
<body data-page="assistencia-cras1" data-module="assistencia-social">
    <div class="app-shell">
        <aside class="app-sidebar" id="appSidebar" aria-label="Menu principal"></aside>
        <div class="app-main">
            <header class="app-topbar" id="appTopbar"></header>
            <main class="app-content">
                <section class="unit-banner"><div class="unit-banner-main"><span class="unit-symbol"><i class="bi bi-building"></i></span><div><div class="eyebrow mb-1"><i class="bi bi-geo-alt"></i>Unidade socioassistencial</div><h1>CRAS 1</h1><p>Centro de Referência de Assistência Social — Território Norte</p></div></div><div class="unit-banner-actions"><button class="btn btn-light" type="button" data-demo-action="ver localização"><i class="bi bi-map"></i>Localização</button><button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#newServiceModal"><i class="bi bi-plus-lg"></i>Novo atendimento</button></div></section>
                <section class="dashboard-grid" aria-label="Indicadores da unidade">
                        ...
                        <strong class="stat-value">1.842</strong>
                    ...
                    <article class="content-card col-span-8"><div class="card-heading"><div><div class="card-kicker">Produção da unidade</div><h2>Atendimentos por semana</h2><p>Histórico das últimas oito semanas.</p></div><span class="status-badge status-success"><i class="bi bi-arrow-repeat"></i>Atualizado hoje</span></div><div class="chart-wrap"><canvas id="cras1Production" data-chart="bar" data-chart-labels='["S1", "S2", "S3", "S4", "S5", "S6", "S7", "S8"]' data-chart-values='[246, 271, 254, 289, 278, 304, 296, 318]' data-chart-label="Atendimentos" aria-label="Atendimentos"></canvas></div></article>
                    <article class="content-card col-span-4"><div class="card-heading"><div><div class="card-kicker">Unidade</div><h2>Informações operacionais</h2></div></div><div class="reference-card"><span>Território de abrangência</span><strong>São Sebastião, Chagas Aguiar, Urucu e comunidades próximas</strong></div><div class="reference-card"><span>Coordenação</span><strong>Ana Paula Costa</strong></div><div class="reference-card"><span>Horário</span><strong>Segunda a sexta, 08h às 17h</strong></div><div class="reference-card"><span>Contato institucional</span><strong>(97) 3561-0000 · unidade@sigas.coari.am.gov.br</strong></div></article>
