...
<header class="module-topbar frontend-topbar">
    <button class="btn btn-light btn-icon d-lg-none" type="button" data-module-menu-toggle aria-expanded="false" aria-controls="moduleSidebar" aria-label="Abrir menu"><i class="bi bi-list"></i></button>
