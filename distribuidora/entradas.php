...
<body>
                ...
                <div class="card-style mb-30">
                    <div class="row g-3 align-items-end">
                        <div class="col-12 col-md-6 col-lg-3">
                            ...
                            <input type="text" class="form-control compact" id="qEntradas"
                                placeholder="NF, produto, fornecedor..." />
                        </div>
                        ...
                        <div class="col-12 col-md-6 col-lg-3">
                            <div class="d-grid gap-2 d-sm-flex justify-content-sm-end flex-wrap">
                                <button class="main-btn primary-btn btn-hover btn-compact" data-bs-toggle="modal"
                                    data-bs-target="#modalEntrada" id="btnNovo">
                ...
                <div class="card-style mb-30">
                    <div class="table-responsive">
                        <table class="table text-nowrap" id="tbEntradas">
                            ...
                            <tbody>
                                <tr data-fornecedor="Fornecedor A" data-data="2026-02-26">
                                    <td><img class="prod-img" alt="Arroz" /></td>
                                    <td class="date">26/02/2026</td>
                                    <td class="nf">NF-1021</td>
                                    <td class="forn">Fornecedor A</td>
                                    <td class="cod">P0001</td>
                                    <td class="prod">Arroz 5kg (Tipo 1)</td>
                                    <td class="und">Pacote</td>
                                    <td class="td-center qtd">10</td>
                                    <td class="td-center custo">R$ 22,00</td>
                                    <td class="td-center total">R$ 220,00</td>
                                    <td class="text-end">
                                ...
                                <tr data-fornecedor="Fornecedor B" data-data="2026-02-25">
                                    <td><img class="prod-img" alt="Detergente" /></td>
                                    <td class="date">25/02/2026</td>
                                    <td class="nf">NF-0987</td>
                                    <td class="forn">Fornecedor B</td>
                                    <td class="cod">P0003</td>
                                    <td class="prod">Detergente 500ml</td>
                                    <td class="und">Unidade</td>
                                    <td class="td-center qtd">40</td>
                                    <td class="td-center custo">R$ 2,10</td>
                                    <td class="td-center total">R$ 84,00</td>
                                    <td class="text-end">
                                        <button class="main-btn light-btn btn-hover icon-btn btnEdit" title="Editar"><i
                                                class="lni lni-pencil"></i></button>
                                        <button class="main-btn danger-btn-outline btn-hover icon-btn btnDel"
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                    ...
                    <form id="formEntrada">
                        ...
                        <div class="row g-3">
                                ...
                                <div class="d-flex justify-content-center">
                                    <div class="img-block text-center">
                                        ...
                                        <div class="d-flex flex-column gap-2 align-items-center">
                                            ...
                                            <input type="file" class="form-control compact" id="pImagem"
                                                accept="image/*" />
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="date" class="form-control compact" id="pData" required />
                            </div>

                            <div class="col-md-3">
                                <label class="form-label">NF</label>
                                <input type="text" class="form-control compact" id="pNF" placeholder="Ex: NF-1022"
                                    required />
                            </div>

                            <div class="col-md-6">
                                <label class="form-label">Fornecedor</label>
                                <input type="text" class="form-control compact" id="pFornecedor"
                                    placeholder="Nome do fornecedor" required />
                            </div>

                            <div class="col-md-3">
                                <label class="form-label">Código</label>
                                <input type="text" class="form-control compact" id="pCodigo" placeholder="Ex: P0001"
                                    required />
                            </div>

                            <div class="col-md-6">
                                <label class="form-label">Produto</label>
                                <input type="text" class="form-control compact" id="pProduto"
                                    placeholder="Nome do produto" required />
                            </div>

                            <div class="col-md-3">
                                <label class="form-label">Unidade</label>
                                <select class="form-select compact" id="pUnidade" required>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" class="form-control compact td-center" id="pQtd" min="0" value="0"
                                    required />
                            </div>

                            <div class="col-md-4">
                                <label class="form-label">Custo (un)</label>
                                <input type="text" class="form-control compact td-center" id="pCusto" placeholder="0,00"
                                    required />
                            </div>

                            <div class="col-md-4">
                                <label class="form-label">Total</label>
                                <input type="text" class="form-control compact td-center" id="pTotal" placeholder="0,00"
                                    readonly />
                            </div>
                        </div>
                    </form>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="main-btn primary-btn btn-hover btn-compact" id="btnSalvarEntrada">
    ...
    `);
        ...
        function aplicarFiltros() {
            ...
            const forn = norm(fFornecedor.value);
            ...
            rows.forEach(tr => {
                ...
                const rForn = norm(tr.getAttribute('data-fornecedor'));
                const rData = tr.getAttribute('data-data') || '';

                let ok = true;
                if (q && !text.includes(q)) ok = false;
                if (forn && rForn !== forn) ok = false;
        ...
        tb.addEventListener('click', (e) => {
            ...
            if (btnDel) {
                const nf = tr.querySelector('.nf')?.innerText || '';
            ...
            if (btnEdit) {
                ...
                // data
                const br = tr.querySelector('.date')?.innerText.trim() || '';
                pData.value = ymdFromBR(br) || '';

                pNF.value = tr.querySelector('.nf')?.innerText.trim() || '';
                pFornecedor.value = tr.querySelector('.forn')?.innerText.trim() || '';
                pCodigo.value = tr.querySelector('.cod')?.innerText.trim() || '';
                pProduto.value = tr.querySelector('.prod')?.innerText.trim() || '';
                pUnidade.value = tr.querySelector('.und')?.innerText.trim() || '';
                pQtd.value = Number(tr.querySelector('.qtd')?.innerText.trim() || 0);
                pCusto.value = (tr.querySelector('.custo')?.innerText || '').replace('R$', '').trim().replace('.', '').replace(',', ',');
                pTotal.value = tr.querySelector('.total')?.innerText.trim() || fmtBRL(0);
        ...
        document.getElementById('btnSalvarEntrada').addEventListener('click', () => {
            if (!pData.value || !pNF.value.trim() || !pFornecedor.value.trim() || !pCodigo.value.trim() || !pProduto.value.trim() || !pUnidade.value) {
            ...
            const dataBR = brDateFromYMD(pData.value);
            const imgSrc = imgData.value || DEFAULT_IMG;

            const htmlRow = `
        <tr data-fornecedor="${pFornecedor.value.trim()}" data-data="${pData.value}">
          <td><img class="prod-img" src="${imgSrc}" alt="${pProduto.value.trim().replaceAll('"', '')}" /></td>
          <td class="date">${dataBR}</td>
          <td class="nf">${pNF.value.trim()}</td>
          <td class="forn">${pFornecedor.value.trim()}</td>
          <td class="cod">${pCodigo.value.trim()}</td>
          <td class="prod">${pProduto.value.trim()}</td>
          <td class="und">${pUnidade.value}</td>
          <td class="td-center qtd">${qtd}</td>
          <td class="td-center custo">${fmtBRL(custo)}</td>
          <td class="td-center total">${fmtBRL(total)}</td>
          <td class="text-end">
      ...
      `;
        ...
        // ✅ Excel (.xls) estilizado + título centralizado + colunas numéricas centralizadas
        function exportExcel() {
            ...
            const forn = fFornecedor.value || 'Todos';
            const ini = dtIni.value || '';
            const fim = dtFim.value || '';
            ...
            // centralizar: Qtd=6, Custo=7, Total=8
      ...
      `;
            ...
            html += `<tr><td class="muted">Fornecedor:</td><td>${forn}</td><td class="muted">Período:</td><td colspan="6">${ini || '—'} até ${fim || '—'}</td></tr>`;
        ...
        function exportPDF() {
            ...
            doc.text(`Fornecedor:  ${forn} | Período:  ${ini} até ${fim}`, M, 92);

            const head = [['Data', 'NF', 'Fornecedor', 'Código', 'Produto', 'Unidade', 'Qtd', 'Custo', 'Total']];
