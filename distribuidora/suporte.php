...
<head>
    ...
    <style>
        .card-style { border: 1px solid rgba(148, 163, 184, .22); border-radius: 16px; background: #fff; overflow: hidden; margin-bottom: 24px; }
        .card-style .head { padding: 18px 20px; border-bottom: 1px solid rgba(148, 163, 184, .18); background: #f8fafc; }
        .card-style .body { padding: 20px; }
