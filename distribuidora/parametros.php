...
<head>
    ...
    <style>
        ...
        .card-style .head { padding: 14px 16px; border-bottom: 1px solid rgba(148, 163, 184, .18); display: flex; align-items: center; justify-content: space-between; }
    ...
    <main class="main-wrapper active">
        ...
        <section class="section"><div class="container-fluid p-4">
            ...
            <div class="card-style mb-3">
                <div class="head"><div><h5 class="mb-0">Parâmetros do Sistema</h5><div class="muted">Configurações globais</div></div><button id="btnNovo" class="main-btn primary-btn btn-hover"><i class="lni lni-plus"></i> Novo</button></div>
