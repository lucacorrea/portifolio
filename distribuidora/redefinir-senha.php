...
$erro = flash_pop('redefine_erro');
$ok   = flash_pop('redefine_ok');

$old = $_SESSION['redefine_old'] ?? [];
unset($_SESSION['redefine_old']);

$emailOld = trim((string)($_GET['email'] ?? (is_array($old) ? ($old['email'] ?? '') : '')));
$codigoOld = is_array($old) ? (string)($old['codigo'] ?? '') : '';
$selfUrl = $_SERVER['PHP_SELF'] ?? 'redefinir-senha.php';
?>
<!DOCTYPE html>
<html lang="pt-BR">
<head>
  ...
  <title>Redefinir Senha | Painel da Distribuidora PLHB</title>
        ...
        <div class="row g-0 auth-row">
          ...
          <div class="col-lg-6 auth-left">
            <div class="auth-cover-content">
              ...
              <p>
                Digite o codigo recebido por e-mail e informe sua nova senha.
              </p>
              <div class="cover-image">
                <img src="assets/images/auth/signin-image.svg" alt="Redefinir senha" />
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-6 auth-right">
            <div class="signup-wrapper">
              ...
              <h2 class="form-title">Confirmar codigo</h2>
              ...
              <form action="./assets/auth/processarRedefinirSenha.php" method="post" autocomplete="off">
                <?= csrf_input(); ?>
                ...
                <div class="input-style-1">
                  <label for="codigo">Codigo recebido</label>
                  <input
                    type="text"
                    id="codigo"
                    name="codigo"
