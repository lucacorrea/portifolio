...
<body>
                            ...
                            <tbody>
                                <?php foreach ($produtos as $p): ?>
                                    ...
                                    <tr
                                        ...
                                        data-img="<?= e($img) ?>">
                                        <td><img class="prod-img" alt="<?= e((string)$p['nome']) ?>" src="<?= e($img) ?>" /></td>
    ...
    `);
        ...
        // Excel/PDF continuam funcionando lendo a tabela visível (igual seu código original)
        // (Se quiser eu adapto 100% igual ao seu, mas já está ok mantendo os índices)
    </script>
</body>
