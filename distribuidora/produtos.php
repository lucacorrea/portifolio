...
/**
 * IMAGEM:
 * - arquivo fica salvo/removido em: ./images/
 * - para EXIBIR no produtos.php, você pediu para usar prefixo: ./assets/dados/produtos/
 *   então montamos a URL assim:
 *     assets/dados/produtos/../../../images/arquivo.jpg  (equivale a ./images/arquivo.jpg)
 */
const IMG_BASE = './assets/dados/produtos/images/';
...
{
    $p = normalize_img_path($dbValue);
    if ($p === '') return '';
    return IMG_BASE . $p; // começa com ./assets/dados/produtos/...
}
?>
<!DOCTYPE html>
<html lang="pt-BR">
                        ...
                        <table class="table text-nowrap" id="tbProdutos">
                            ...
                            <tbody>
                                <?php foreach ($produtos as $p): ?>
                                    ...
                                    $imgDb = (string)($p['imagem'] ?? '');
                                    $imgUrl = img_url_for_browser($imgDb); // começa com assets/dados/produtos/...
                                    ?>
                                    <tr
                                        data-id="<?= $id ?>"
