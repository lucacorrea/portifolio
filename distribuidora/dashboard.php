              ...
              <div class="table-responsive">
                <table class="table tbl-sm">
                  ...
                  <tbody>
                    ...
                    <?php if (!$recent): ?>
                      <tr>
                        <td colspan="4" class="text-center muted">Sem vendas.</td>
                      </tr>
                    <?php endif; ?>
                  </tbody>
                </table>
              ...
              <div class="table-responsive">
                <table class="table tbl-sm">
                  ...
                  <tbody>
                    ...
                    <?php if (!$low): ?>
                      <tr>
                        <td colspan="5" class="text-center muted">Nenhum produto abaixo do mínimo.</td>
                      </tr>
                    <?php endif; ?>
                  </tbody>
                </table>
  ...
  <script>
    ...
    const chartFlow12m = new Chart(ctxFlow, {
      ...
      data: {
        ...
        datasets: [{
            label: 'Entradas (qtd)',
            data: INIT.flow12m.entradas,
            tension: .25
          },
          {
            label: 'Saídas (qtd)',
            data: INIT.flow12m.saidas,
            tension: .25
          },
        ]
      },
    ...
    async function loadChart(name, period) {
      ...
      const res = await fetch('dashboard.php?' + qs.toString(), {
        headers: {
