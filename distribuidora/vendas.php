...
<head>
    ...
    <style>
        ...
        .preview-box { width:100%; height:130px; border-radius:16px; border:1px dashed rgba(148, 163, 184, .55);
            background: rgba(248, 250, 252, .7); display:flex; align-items:center; justify-content:center; padding:10px; text-align:center;
        }
                          ...
                          <div class="checkout-body">
                              ...
                              <div class="last-box">
                                  ...
                                  <div class="list" id="lastList">
                                    <?php if (!$last): ?>
                                      <div class="cup">
                                        <div class="left"><div class="n">—</div><div class="s">Sem cupons ainda</div></div>
                                        <div class="right"><div class="v">R$ 0,00</div></div>
                                      </div>
...
async function renderLastSales() {
  try {
    const r = await fetchJSON("./assets/dados/vendas/ultimasVendas.php");
